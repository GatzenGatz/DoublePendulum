...
\noindent This note analyzes a double compound pendulum consisting of two rods of equal length and uniform mass distribution. All variables with 1 in the index describe the first rod, all variables with 2 the second, where the angles are between the rod and their relative equilibrium position. The kinetic and potential energies are given by
\begin{align}
