...
\begin{align}
	...
	&\geq 0
\end{align}
K is invertible for each $(\varphi_1, \varphi_2)$. The inverse matrix of a $2\cross 2$-matrix can be computed through
\begin{align}
...
\end{align}
Because the kinetic energy $T$ is a homogeneous quadratic function and the potential energy doesn't depend on the velocity, so $p=\pdv{T}{\dot{\varphi}}$, $T=\frac{1}{2}p\dot{\varphi}$. 
